...
An example of when I showed perseverance and effective communication skills is: during our final project, after hours, I was willingly working on CSS features whilst one of my team members was struggling with a key feature of our website. When she reached out for help, I decided to pause what I was working on as I felt that the key feature should be the priority. I offered to pair-program to help solve the issue. Together, we were able to break down the issue and work on the feature's functionality step by step until it was working successfully.
